...
/// Home / dashboard principal del cliente (estética pastel Vetgo).
              ...
              child: Column(
                ...
                children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Vacuna anual de Luna en 6 días · Cita de revisión Michi el jueves',
                  ...
                  SizedBox(
                    height: 112,
                    child: pets.isEmpty
                        ? Text('Añade una mascota para verla aquí.', style: theme.textTheme.bodyMedium?.copyWith(color: muted))
                        : ListView.separated(
          ...
          child: ClientSoftCard(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Elige fecha sugerida. Esta acción simula una llamada al servidor.',
