...
class _ProfileOnboardingFlowState extends State<ProfileOnboardingFlow> {
  ...
  Future<void> _submit() async {
    ...
    if (token == null || token.isEmpty) {
      setState(() => _error = 'Sesiùn no vùlida. Vuelve a iniciar sesiùn.');
      return;
    }
        ...
        child: AuthStagger(
          ...
          children: [
            const AuthBrandHeader(
              ...
              subtitle: 'Cuùntanos cùmo vas a usar Vetgo para personalizar tu experiencia.',
            ),
            const SizedBox(height: 28),
            _RoleCard(
              title: 'Soy dueÒo de mascota',
            ...
            _RoleCard(
              ...
              subtitle: 'Ofrezco consultas y servicios a domicilio o en lÌnea.',
